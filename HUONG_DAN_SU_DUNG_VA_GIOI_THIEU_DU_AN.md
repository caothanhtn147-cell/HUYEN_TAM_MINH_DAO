...
graph TD
    ...
    HT --> P2[🃏 Tarot Deck & ☯️ I Ching Engine]
    HT --> P3[🏛️ Bát Tự & Tử Vi Engine]
    HT --> P4[🌿 Dưỡng Đạo Educational System]
    HT --> P5[📊 Self-Reflection Journal System]
    HT --> P6[🛡️ Admin Governance Dashboard]

    HT --> M1[📸 Canvas Story Exporter 9:16]
    HT --> M2[🌐 Multilingual i18n: VIE 🇻🇳 / ENG 🇺🇸]
    HT --> M3[☁️ Cloud Deployment Configs]
    HT --> M4[💳 VietQR Auto Payment Engine]
```
